...
For GPA (for instance), a one unit increase in GPA (e.g. from 2.0 to 3.0) is associated with 217% increase in odds of admission to a university. This assumes other variables are held at a constant value (mean). 
